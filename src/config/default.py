...
_CN.LOFTR.COARSE.NUM_PROTOTYPE = 16
_CN.LOFTR.COARSE.PROTOTYPE_QUERY_TYPE = 'query'
_CN.LOFTR.COARSE.PROTOTYPE_EXTRACTOR_TYPE = 'linear'  # or 'transformer'
_CN.LOFTR.COARSE.ANCHOR_QUERY_ONLY_PE = False
_CN.LOFTR.COARSE.USE_GEO_FEAT = False
_CN.LOFTR.COARSE.USE_TRANS_MATRIX = False

_CN.LOFTR.COARSE.ANCHOR_EXTRACTOR = CN()
_CN.LOFTR.COARSE.ANCHOR_EXTRACTOR.ANCHOR_NUM = _CN.LOFTR.COARSE.NUM_PROTOTYPE
_CN.LOFTR.COARSE.ANCHOR_EXTRACTOR.FEAT_CHANNELS = _CN.LOFTR.COARSE.D_MODEL
_CN.LOFTR.COARSE.ANCHOR_EXTRACTOR.USE_GT_MATCHES_IN_TRAINING = False
_CN.LOFTR.COARSE.ANCHOR_EXTRACTOR.USE_NMS = True
_CN.LOFTR.COARSE.ANCHOR_EXTRACTOR.NMS_POOLING_KS = 2
_CN.LOFTR.COARSE.ANCHOR_EXTRACTOR.MATCHER = _CN.LOFTR.MATCH_COARSE.clone()
_CN.LOFTR.COARSE.ANCHOR_EXTRACTOR.MATCHER.THR = 0.5

_CN.LOFTR.COARSE.GEO_LAYER = CN()
_CN.LOFTR.COARSE.GEO_LAYER.USE_WARP = False
_CN.LOFTR.COARSE.GEO_LAYER.USE_GT_MATCHES_IN_TRAINING = _CN.LOFTR.COARSE.ANCHOR_EXTRACTOR.USE_GT_MATCHES_IN_TRAINING
_CN.LOFTR.COARSE.GEO_LAYER.ANCHOR_NUM = _CN.LOFTR.COARSE.ANCHOR_EXTRACTOR.ANCHOR_NUM
...
_CN.LOFTR.COARSE.GEO_LAYER.ATTENTION_N_HEAD = 8

_CN.LOFTR.COARSE.PROTOTYPE_EXTRACTOR = CN()
_CN.LOFTR.COARSE.PROTOTYPE_EXTRACTOR.NUM_BLOCK_FIRST = 1
_CN.LOFTR.COARSE.PROTOTYPE_EXTRACTOR.NUM_BLOCK = 0.5
_CN.LOFTR.COARSE.PROTOTYPE_EXTRACTOR.BLOCK = CN()
_CN.LOFTR.COARSE.PROTOTYPE_EXTRACTOR.BLOCK.D_MODEL = _CN.LOFTR.COARSE.D_MODEL
_CN.LOFTR.COARSE.PROTOTYPE_EXTRACTOR.BLOCK.N_HEAD = _CN.LOFTR.COARSE.NHEAD
_CN.LOFTR.COARSE.PROTOTYPE_EXTRACTOR.BLOCK.ATTENTION = _CN.LOFTR.COARSE.ATTENTION

# _CN.LOFTR.COARSE.NUM_PROTOTYPE = 64
# _CN.LOFTR.COARSE.PROTOTYPE_EXTRACTOR = 'transformer'
# _CN.LOFTR.COARSE.PROTOTYPE_NHEAD = 8  # head 要不要调整
#
_CN.LOFTR.COARSE.OT_LAYER = CN()
_CN.LOFTR.COARSE.OT_LAYER.TYPE = 'dual_softmax'  # or 'sinkhorn'
_CN.LOFTR.COARSE.OT_LAYER.DSMAX_TEMPERATURE = 1
_CN.LOFTR.COARSE.OT_LAYER.SKH_ITERS = 1000
_CN.LOFTR.COARSE.OT_LAYER.SKH_INIT_BIN_SCORE = 0.1
_CN.LOFTR.COARSE.OT_LAYER.SKH_PREFILTER = False
...
_CN.LOFTR.LOSS.USE_COARSE_I_LOSS = True
_CN.LOFTR.LOSS.COARSE_WEIGHT_I = 0.4
_CN.LOFTR.LOSS.USE_COARSE_GEO_I_LOSS = False
_CN.LOFTR.LOSS.COARSE_WEIGHT_GEO_I = 0.2
_CN.LOFTR.LOSS.USE_DIVERSITY_LOSS = True
_CN.LOFTR.LOSS.DIVERSITY_WEIGHT = 0.1
