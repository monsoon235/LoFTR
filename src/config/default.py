...
_CN.LOFTR.COARSE.PROTOTYPE_EXTRACTOR.NUM_BLOCK_FIRST = 6
_CN.LOFTR.COARSE.PROTOTYPE_EXTRACTOR.NUM_BLOCK = 0
...
_CN.LOFTR.COARSE.OT_LAYER.DSMAX_TEMPERATURE = 1  # 此处应该仿照 attention 中的 sqrt(d)
...
_CN.LOFTR.LOSS.USE_DIVERSITY_LOSS = False
