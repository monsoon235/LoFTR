...
_CN.LOFTR.COARSE.PROTOTYPE_EXTRACTOR.BLOCK_NUM = 4  # 堆叠
...
_CN.LOFTR.COARSE.OT_LAYER.DSMAX_TEMPERATURE = 0.1
...
_CN.LOFTR.LOSS.COARSE_WEIGHT_I = [i / len(_CN.LOFTR.COARSE.LAYER_NAMES)
                                  for i in range(len(_CN.LOFTR.COARSE.LAYER_NAMES))]
_CN.LOFTR.LOSS.COARSE_WEIGHT_GEO_I = [0.5 * i / len(_CN.LOFTR.COARSE.LAYER_NAMES)
                                      for i in range(len(_CN.LOFTR.COARSE.LAYER_NAMES))]
