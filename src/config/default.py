...
_CN.LOFTR.COARSE.PROTOTYPE_QUERY_TYPE = 'anchor'
_CN.LOFTR.COARSE.USE_GEO_FEAT = True
...
_CN.LOFTR.COARSE.PROTOTYPE_EXTRACTOR.NUM_BLOCK_FIRST = 4
_CN.LOFTR.COARSE.PROTOTYPE_EXTRACTOR.NUM_BLOCK = 1
...
_CN.LOFTR.LOSS.USE_COARSE_GEO_I_LOSS = True
