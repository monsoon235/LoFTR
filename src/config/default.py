...
_CN.LOFTR.COARSE.USE_V4 = True
_CN.LOFTR.COARSE.CLASS_NUM = 8
_CN.LOFTR.COARSE.WINDOW_SIZE = 5
_CN.LOFTR.COARSE.SELECT_WINDOW_NUM = 10
_CN.LOFTR.COARSE.OTHER_WINDOW_SAMPLE_NUM = 1
