...
_CN.LOFTR.FINE.USE_PROTOTYPE = False
...
_CN.LOFTR.LOSS.COARSE_PROTOTYPE_WEIGHT = 0.0
_CN.LOFTR.LOSS.COARSE_USE_PROTOTYPE_DIVERSITY_LOSS = True
_CN.LOFTR.LOSS.COARSE_PROTOTYPE_DIVERSITY_WEIGHT = 0.0
