...
_CN.LOFTR.COARSE.NUM_PROTOTYPE = 32
...
_CN.LOFTR.COARSE.USE_TRANS_MATRIX = True
...
_CN.LOFTR.COARSE.OT_LAYER.DSMAX_TEMPERATURE = 5.6  # 此处应该仿照 attention 中的 sqrt(d)
_CN.LOFTR.COARSE.OT_LAYER.SKH_ITERS = 3
_CN.LOFTR.COARSE.OT_LAYER.SKH_INIT_BIN_SCORE = 1.0
